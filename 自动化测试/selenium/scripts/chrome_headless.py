...
driver = webdriver.Chrome(executable_path=r"C:\Users\liul5\Documents\test\after_Nov\driver\chromedriver.exe",
                          chrome_options=chrome_options,
                          service_args=['--verbose',
                                        '--log-path=C:\\Users\\liul5\\Documents\\test\\after_Nov\\chromedriver.log'])
